import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject as inject$1, toRef, shallowRef, computed, watchEffect, toRefs, Fragment, capitalize, isVNode, Comment, unref, warn, provide, ref, defineComponent as defineComponent$1, createVNode, mergeProps, h, isReadonly, isRef, isShallow, isReactive, toRaw, watch, onScopeDispose, defineAsyncComponent, Suspense, nextTick, useSSRContext, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, appendResponseHeader } from "C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/radix3/dist/index.mjs";
import { defu } from "C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-C_xgmBj4.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-Jh3U3YFM.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DN161cAj.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CQsZYZ-C.js"));
...
export {
  ...
  _export_sfc as _,
  isOn as a,
  checkPrintable as a0,
  defineFunctionalComponent as a1,
  getObjectValueByPath as a2,
  isEmpty as a3,
  useNuxtApp as a4,
  ...
  useRoute as a8,
  fetchDefaults as a9,
  useRequestFetch as aa,
  useRuntimeConfig as ab,
  keys as ac,
  useRouter as ad,
  resolveRouteObject as ae,
  navigateTo as af,
  hashMode as ag,
  nuxtLinkDefaults as ah,
  isCssColor as ai,
  isParsableColor as aj,
  parseColor as ak,
  getForeground as al,
  propsFactory as b,
  getCurrentInstanceName as c,
