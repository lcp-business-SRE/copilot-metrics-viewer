import { defineComponent, computed, withCtx, createTextVNode, createVNode, toDisplayString, withDirectives, createBlock, createCommentVNode, vShow, openBlock, Fragment, renderList, toRef, shallowRef, mergeProps, ref, Text, capitalize, h, camelize, watch, nextTick, resolveDirective, Transition, provide, inject, getCurrentInstance as getCurrentInstance$1, toRefs, TransitionGroup, resolveDynamicComponent, reactive, unref, watchEffect, resolveComponent, toValue, onServerPrefetch, withModifiers, cloneVNode, onScopeDispose, Teleport, toRaw, readonly, useSSRContext, createElementBlock } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderSlot, ssrRenderClass } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/vue/server-renderer/index.mjs';
import { ab as useRuntimeConfig, _ as _export_sfc, g as genericComponent, a4 as useNuxtApp, a7 as getNuxtAppCtx, b as propsFactory, f as provideTheme, l as useRtl, p as provideDefaults, e as convertToUnit, h as useIcon, j as flattenFragments, k as getCurrentInstance, n as useProxiedModel, o as clamp, A as useLocale, a6 as createError, m as makeThemeProps, I as IconValue, c as getCurrentInstanceName, d as destructComputed, i as includes, w as getUid, q as hasEvent, r as deepEqual, u as useUserSession, s as isObject, B as useDisplay, L as useGoTo, H as omit, ac as keys, a8 as useRoute$2, a5 as asyncDataDefaults, M as makeDisplayProps, N as focusableChildren, x as wrapInArray, y as consoleWarn, z as findChildrenWithProvide, t as keyCodes, v as breakpoints, R as getPropertyFromItem, a2 as getObjectValueByPath, a3 as isEmpty, C as createRange, $ as ensureValidVNode, a1 as defineFunctionalComponent, a as isOn, D as keyValues, F as filterInputAttrs, a0 as checkPrintable, G as matchesSelector, V as isClickInsideElement, Q as deprecate, J as useToggleScope, E as EventProp, X as pick$1, Y as callEvent, S as focusChild, W as getNextElement, Z as debounce$1, K as only, U as templateRef, O as consoleError, P as defineComponent$1, T as defer, a9 as fetchDefaults, aa as useRequestFetch } from './server.mjs';
import { _ as __nuxt_component_0$2 } from './nuxt-link-KWZ0T8gl.mjs';
import { Chart, ArcElement, CategoryScale, LinearScale, BarElement, PointElement, LineElement, Title, Tooltip, Legend } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/chart.js/dist/chart.js';
import { Bar, Line, Pie } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/vue-chartjs/dist/index.js';
import { u as useBackgroundColor, a as useBorder, b as useElevation, c as useRounded, d as useRender, e as useDimension, f as useTextColor, m as makeComponentProps, g as useSsrBoot, h as makeTagProps, i as makeRoundedProps, j as makeElevationProps, k as makeBorderProps, l as makeDimensionProps, n as useColor, o as useResizeObserver, V as VMain } from './VMain-DMWU_6jf.mjs';
import { executeAsync } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/unctx/dist/index.mjs';
import { hash } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { u as useHead } from './v4-o0cUfLFJ.mjs';
import { debounce } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/perfect-debounce/dist/index.mjs';
import { h as getDisplayName } from '../_/nitro.mjs';
import { isPlainObject } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/@vue/shared/dist/shared.cjs.prod.js';
import { useRoute as useRoute$1 } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/vue-router/dist/vue-router.node.mjs';
...
function useVirtual(props, items) {
  ...
  const updateOffsets = debounce$1(() => {
    const start = performance.now();
    offsets[0] = 0;
...
//# sourceMappingURL=index-C_xgmBj4.mjs.map
