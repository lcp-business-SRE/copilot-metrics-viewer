import { isVNode, Comment, Fragment, inject as inject$1, computed, watch, onScopeDispose, warn, shallowRef, hasInjectionContext, reactive, watchEffect, toRefs, provide, defineComponent as defineComponent$1, unref, getCurrentInstance as getCurrentInstance$1, ref, toRaw, capitalize, effectScope, createVNode, mergeProps, toRef, isRef, defineAsyncComponent, h, shallowReactive, Suspense, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isShallow, isReactive, getCurrentScope, withCtx, nextTick, useSSRContext } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/ofetch/dist/node.mjs';
import { f as baseURL } from '../_/nitro.mjs';
...
import { getContext, executeAsync } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendResponseHeader, appendHeader } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/defu/dist/defu.mjs';
import { withQuery, hasProtocol, isScriptProtocol, joinURL } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/work/github/copilot-metrics-viewer/copilot-metrics-viewer/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-C_xgmBj4.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Jh3U3YFM.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DN161cAj.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CQsZYZ-C.mjs'));
...
export { ensureValidVNode as $, useLocale as A, useDisplay as B, createRange as C, keyValues as D, EventProp as E, filterInputAttrs as F, matchesSelector as G, omit as H, IconValue as I, useToggleScope as J, only as K, useGoTo as L, makeDisplayProps as M, focusableChildren as N, consoleError as O, defineComponent as P, deprecate as Q, getPropertyFromItem as R, focusChild as S, defer as T, templateRef as U, isClickInsideElement as V, getNextElement as W, pick as X, callEvent as Y, debounce as Z, _export_sfc as _, isOn as a, checkPrintable as a0, defineFunctionalComponent as a1, getObjectValueByPath as a2, isEmpty as a3, useNuxtApp as a4, asyncDataDefaults as a5, createError as a6, getNuxtAppCtx as a7, useRoute as a8, fetchDefaults as a9, useRequestFetch as aa, useRuntimeConfig as ab, keys as ac, useRouter as ad, resolveRouteObject as ae, navigateTo as af, hashMode as ag, nuxtLinkDefaults as ah, isCssColor as ai, isParsableColor as aj, parseColor as ak, getForeground as al, propsFactory as b, getCurrentInstanceName as c, destructComputed as d, entry$1 as default, convertToUnit as e, provideTheme as f, genericComponent as g, useIcon as h, includes as i, flattenFragments as j, getCurrentInstance as k, useRtl as l, makeThemeProps as m, useProxiedModel as n, clamp as o, provideDefaults as p, hasEvent as q, deepEqual as r, isObject as s, keyCodes as t, useUserSession as u, breakpoints as v, getUid as w, wrapInArray as x, consoleWarn as y, findChildrenWithProvide as z };
