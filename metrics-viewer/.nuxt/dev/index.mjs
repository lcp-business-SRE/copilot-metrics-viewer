...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getQuery as getQuery$1, useSession, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/@vue/shared/dist/shared.cjs.js';
import { readFileSync } from 'node:fs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/ufo/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/defu/dist/defu.mjs';
import { ofetch, FetchError, createFetch, Headers as Headers$1 } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/ofetch/dist/node.mjs';
import { snakeCase, upperFirst } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/scule/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr, { destr as destr$1 } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/klona/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/devalue/index.js';
import { toValue, isRef } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/hookable/dist/index.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/source-map/source-map.js';
import { ProxyAgent, setGlobalDispatcher } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/undici/index.js';
import { walkResolver } from 'file://C:/work/github/copilot-metrics-viewer/metrics-viewer/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/work/github/copilot-metrics-viewer/metrics-viewer/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/work/github/copilot-metrics-viewer/metrics-viewer","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/work/github/copilot-metrics-viewer/metrics-viewer/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/work/github/copilot-metrics-viewer/metrics-viewer/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/work/github/copilot-metrics-viewer/metrics-viewer/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/work/github/copilot-metrics-viewer/metrics-viewer/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "session": {
    "name": "nuxt-session",
    "password": "7a9d4473e2a5427cae7a68215fdf5811",
    "cookie": {
      "sameSite": "lax"
    },
    "maxAge": 21600
...
const _0mzLBlzPSEf5j0T7Vib21Ksg_bSYUIfSMTNhb1Z6E = (function(nitro) {
...
const _UzoIgX8mMotTBPm4uQIFZAmdLwAC11wcFn1WOqapuo = defineNitroPlugin((nitro) => {
...
const _hbtyBXYLyyeiAjK3IexGQGuPsY8PeerT2N9XGHH9L8 = defineNitroPlugin((nitroApp) => {
...
const plugins = [
  _0mzLBlzPSEf5j0T7Vib21Ksg_bSYUIfSMTNhb1Z6E,
_UzoIgX8mMotTBPm4uQIFZAmdLwAC11wcFn1WOqapuo,
_hbtyBXYLyyeiAjK3IexGQGuPsY8PeerT2N9XGHH9L8,
_UzoIgX8mMotTBPm4uQIFZAmdLwAC11wcFn1WOqapuo
];
...
const _V1091k = defineEventHandler(async (event) => {
  const config = useRuntimeConfig(event);
...
const _jDDPc6 = defineEventHandler((event) => {
  console.log("Request: " + event.method + " " + getRequestURL(event));
});

const _hwIk3V = eventHandler(async (event) => {
  await clearUserSession(event);
  return { loggedOut: true };
});

const _A33wiy = eventHandler(async (event) => {
...
const getServerEntry = () => import('file://C:/work/github/copilot-metrics-viewer/metrics-viewer/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/work/github/copilot-metrics-viewer/metrics-viewer/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_Dg8WIe = () => Promise.resolve().then(function () { return metrics$1; });
const _lazy_SjAxXt = () => Promise.resolve().then(function () { return seats$1; });
const _lazy_5iMFjQ = () => Promise.resolve().then(function () { return github_get$1; });
const _lazy_AI5PQy = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _V1091k, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _jDDPc6, lazy: false, middleware: true, method: undefined },
  { route: '/api/metrics', handler: _lazy_Dg8WIe, lazy: true, middleware: false, method: undefined },
  { route: '/api/seats', handler: _lazy_SjAxXt, lazy: true, middleware: false, method: undefined },
  { route: '/auth/github', handler: _lazy_5iMFjQ, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_AI5PQy, lazy: true, middleware: false, method: undefined },
  { route: '/api/_auth/session', handler: _hwIk3V, lazy: false, middleware: false, method: "delete" },
  { route: '/api/_auth/session', handler: _A33wiy, lazy: false, middleware: false, method: "get" },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_AI5PQy, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_AI5PQy, lazy: true, middleware: false, method: undefined }
];
...
class BreakdownData {
  constructor(data) {
    __publicField$1(this, "language");
    __publicField$1(this, "editor");
    __publicField$1(this, "suggestions_count");
    __publicField$1(this, "acceptances_count");
    __publicField$1(this, "lines_suggested");
    __publicField$1(this, "lines_accepted");
    __publicField$1(this, "active_users");
    __publicField$1(this, "chat_acceptances");
    __publicField$1(this, "chat_turns");
    __publicField$1(this, "active_chat_users");
...
class Metrics {
  constructor(data) {
    __publicField$1(this, "total_suggestions_count");
    __publicField$1(this, "total_acceptances_count");
    __publicField$1(this, "total_lines_suggested");
    __publicField$1(this, "total_lines_accepted");
    __publicField$1(this, "total_active_users");
    __publicField$1(this, "total_chat_acceptances");
    __publicField$1(this, "total_chat_turns");
    __publicField$1(this, "total_active_chat_users");
    __publicField$1(this, "acceptance_rate_by_count");
    __publicField$1(this, "acceptance_rate_by_lines");
    __publicField$1(this, "day");
    __publicField$1(this, "breakdown");
...
const seats$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: seats
});
